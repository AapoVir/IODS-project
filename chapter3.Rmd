...
Most students have not failed a class According to the linear regression model class failures are positively correlated with high alcohol consumption and the association is statistically significant. 
