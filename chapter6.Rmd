...
First we will attempt to plot our data showing the change of bprs scores over time. Something about this graph is awry but at least it appears to have a descending slope. 
...
Here we attempt plotting the  bprs scores as observed and with fitted values. These lovely drawings look a bit off but at least we can identify the descending slope of the bprs values over time.
